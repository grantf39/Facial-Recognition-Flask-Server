...
RET_IMAGE = './avatar/detected.png'
ORIG_IMAGE = './avatar/avatar.png'
C_RET_IMAGE = './avatar/Compressed_detected.png'
ALLOWED_EXTENSIONS = {'txt', 'pdf', 'png', 'jpg', 'jpeg', 'gif'}
...
if __name__== "__main__":
    ...
    # app.run(host = '172.23.32.1' )

    # app.run(host = '0.0.0.0')
    print("running on get_ip. Copy this into RN ip address: ",getIP )
    app.run(host = str(getIP))
